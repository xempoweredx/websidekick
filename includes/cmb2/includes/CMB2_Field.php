...
class CMB2_Field extends CMB2_Base {
	...
	*************************************************************************************************/
		...
		elseif ( ( $sidekick_type =='sidekick_text' ) || ( $sidekick_type =='sidekick_tel' ) || ( $sidekick_type =='sidekick_email' ) || ( $sidekick_type =='sidekick_url' ) || ( $sidekick_type =='sidekick_password' ) || ( $sidekick_type =='sidekick_textarea' ) || ( $sidekick_type =='sidekick_range' ) || ( $sidekick_type =='sidekick_radio_buttons' ) || ( $sidekick_type =='sidekick_radio_icons' ) || ( $sidekick_type =='sidekick_select' ) || ( $sidekick_type =='colorpicker' ) || ( $sidekick_type =='sidekick_radio' ) || ( $sidekick_type =='sidekick_file' ) || ( $sidekick_type =='sidekick_text_time' ) || ( $sidekick_type =='sidekick_text_date' ) || ( $sidekick_type =='sidekick_text_date_timestamp' ) || ( $sidekick_type =='sidekick_text_datetime_timestamp' ) || ( $sidekick_type =='sidekick_text_datetime_timestamp_timezone' ) ) {
