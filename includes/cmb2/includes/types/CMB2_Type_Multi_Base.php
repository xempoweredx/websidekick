...
abstract class CMB2_Type_Multi_Base extends CMB2_Type_Base {
	...
	/**
	 * CMB2 Generates html for an option element
	 *
	 * @since  1.1.0
	...
	/**
	 * CMB2 Generates html for list item with input
	 *
	 * @since  1.1.0
	...
	/**
	 * CMB2 Generates html for list item with checkbox input
	 *
	 * @since  1.1.0
	 * @param  array $args Override arguments
	 * @param  int   $i    Iterator value
	...
	/**
	 * CMB2 Generates html for concatenated items
	 *
	 * @since  1.1.0
