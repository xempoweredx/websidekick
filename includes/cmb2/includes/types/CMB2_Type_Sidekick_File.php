 ...
 * @link      https://cmb2.io
 */
class CMB2_Type_Sidekick_File extends CMB2_Type_File_Base {
	...
	public function render( $args = array() ) {
		...
		$output .= sprintf(
			'<input class="cmb2-upload-button btn btn-outline-secondary d-inline-block" type="button" value="%1$s" />',
			esc_attr( $this->_text( 'add_upload_file_text', esc_html__( 'Upload File', 'cmb2' ) ) )
		);
