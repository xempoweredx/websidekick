...
class CMB2_Types {
	...
	***************************************/
	...
	public function ninja_text() {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Text', array(
			'class' => 'form-control',
		), 	'input' )->render();
	}

	public function ninja_url() {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Text', array(
			'type'  => 'url',
			'class' => 'form-control',
			'value' => $this->field->escaped_value( 'esc_url' ),
	...
	public function ninja_password() {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Text', array(
			'type'  => 'password',
			'class' => 'form-control',
			'desc'  => $this->_desc(),
	...
	public function ninja_textarea( $args = array() ) {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Ninja_Textarea', $args )->render();
	}

	public function ninja_range() {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Ninja_Range', array(
			'desc'  => $this->_desc(),
		), 	'input' )->render();
	}

	public function ninja_checkbox( $args = array(), $is_checked = null ) {
		// Avoid get_new_render_type since we need a different default for the 3rd argument than ''.
		$render_class_name = $this->get_render_type_class( __FUNCTION__, 'CMB2_Type_Ninja_Checkbox' );
		$this->type = new $render_class_name( $this, $args, $is_checked );
		return $this->type->render();
	}

	// Modified "CMB2_Field.php" (function render_field_callback) AND (function label) AND "ninja-admin-global.css" - 18-10-03 @CG
	public function ninja_checkbox_icon( $args = array(), $is_checked = null ) {
		// Avoid get_new_render_type since we need a different default for the 3rd argument than ''.
		$render_class_name = $this->get_render_type_class( __FUNCTION__, 'CMB2_Type_Ninja_Checkbox' );
		$this->type = new $render_class_name( $this, $args, $is_checked );
		return $this->type->render();
	...
	public function ninja_multicheck( $type = 'checkbox' ) {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Ninja_Multicheck', array(), $type )->render();
	}

	public function ninja_radio( $args = array(), $type = __FUNCTION__ ) {
		return $this->get_new_render_type( $type, 'CMB2_Type_Ninja_Radio', $args, $type )->render();
	}

	// Added CMB2_Type_Ninja_Radio_Buttons.php AND modified CMB2_Type_Multi_Base.php - 18-10-03 @CG
	public function ninja_radio_buttons( $args = array(), $type = __FUNCTION__ ) {
		return $this->get_new_render_type( $type, 'CMB2_Type_Ninja_Radio_Buttons', $args, $type )->render();
	}

	// Added CMB2_Type_Ninja_Radio_Icons.php AND modified CMB2_Type_Multi_Base.php - 18-10-03 @CG
	public function ninja_radio_icons( $args = array(), $type = __FUNCTION__ ) {
		return $this->get_new_render_type( $type, 'CMB2_Type_Ninja_Radio_Icons', $args, $type )->render();
	}

	public function ninja_select( $args = array() ) {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Ninja_Select', $args )->render();
	}

	// Modified "CMB2_Field.php" (function render_field_callback) AND (function label) AND "ninja-admin-global.css" - 18-10-03 @CG
	public function ninja_switch_toggle( $args = array(), $is_checked = null ) {
		// Avoid get_new_render_type since we need a different default for the 3rd argument than ''.
		$render_class_name = $this->get_render_type_class( __FUNCTION__, 'CMB2_Type_Ninja_Checkbox' );
		$this->type = new $render_class_name( $this, $args, $is_checked );
		return $this->type->render();
	...
	// Modified "CMB2_Field.php" (function render_field_callback) AND (function label) AND "ninja-admin-global.css" - 18-10-03 @CG
	public function ninja_switch_slide( $args = array(), $is_checked = null ) {
		// Avoid get_new_render_type since we need a different default for the 3rd argument than ''.
		$render_class_name = $this->get_render_type_class( __FUNCTION__, 'CMB2_Type_Ninja_Checkbox' );
		$this->type = new $render_class_name( $this, $args, $is_checked );
		return $this->type->render();
	...
	// Using "ninja_switch_buttons" as "type" adds specific css and js functions to the standard "radio_buttons" type. Limit "options" to 2! ONLY use BS4 markup "btn-outline-..." for "btn_color". Be sure to set "default" for one of the options. - 18-03-28 @CG
	public function ninja_switch_buttons( $args = array(), $type = __FUNCTION__ ) {
		return $this->get_new_render_type( $type, 'CMB2_Type_Ninja_Radio_Buttons', $args, $type )->render();
	}

	public function ninja_file( $args = array() ) {
		return $this->get_new_render_type( __FUNCTION__, 'CMB2_Type_Ninja_File', $args )->render();
	}
