...
class Websidekick {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Websidekick_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Websidekick_Loader. Orchestrates the hooks of the plugin.
	 * - Websidekick_i18n. Defines internationalization functionality.
	 * - Websidekick_Admin. Defines all hooks for the admin area.
	 * - Websidekick_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-websidekick-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-websidekick-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-websidekick-admin.php';
	 ...
	 *
	 * Uses the Websidekick_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Websidekick_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Websidekick_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Websidekick_Loader    Orchestrates the hooks of the plugin.
	 */
