 ...
 * @link      https://cmb2.io
 */
class CMB2_Type_Sidekick_Text_Datetime_Timestamp extends CMB2_Type_Picker_Base {
	...
	public function date_args( $args, $has_good_value ) {
		$date_args = wp_parse_args( $args['datepicker'], array(
			'class' => 'sidekick-datepicker cmb2-datepicker form-control',
	...
	public function time_args( $args, $has_good_value ) {
		$time_args = wp_parse_args( $args['timepicker'], array(
			'class' => 'cmb2-timepicker text-time sidekick-timepicker form-control',
