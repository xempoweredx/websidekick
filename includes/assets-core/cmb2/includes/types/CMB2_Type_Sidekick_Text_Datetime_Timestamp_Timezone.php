<?php
/**
 * CMB sidekick_text_datetime_timestamp_timezone field type
 *
 * @since  2.2.2
 *
 ...
 * @link      https://cmb2.io
 */
class CMB2_Type_Sidekick_Text_Datetime_Timestamp_Timezone extends CMB2_Type_Base {
	...
	public function render( $args = array() ) {
		...
		$timezone_select_args = wp_parse_args( $args['select_timezone'], array(
			'class'    => 'cmb2_select cmb2-select-timezone custom-select',
