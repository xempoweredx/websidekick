...
class Plugin {
	...
	public static function admin_footer_text( $footer_text ) {
		...
		if ( ! get_option( 'wpslimitlogin_admin_footer_text_rated' ) ) {
			...
			/* translators: 1: WooCommerce 2:: five stars */
				...
				'<a href="https://wordpress.org/support/plugin/wps-limit-login/reviews?rate=5#new-post" target="_blank" class="wc-rating-link" data-rated="' . esc_attr__( 'Thanks :)', 'wps-limit-login' ) . '">&#9733;&#9733;&#9733;&#9733;&#9733;</a>'
			);
			self::wps_limitlogin_enqueue_js( "
            jQuery( 'a.wc-rating-link' ).click( function() {
                jQuery.post( '" . admin_url( 'admin-ajax.php', 'relative' ) . "', { action: 'wpslimitlogin_rated' } );
	 ...
	 * @param string $code
	 */
	public static function wps_limitlogin_enqueue_js( $code ) {
		global $wc_queued_js;
