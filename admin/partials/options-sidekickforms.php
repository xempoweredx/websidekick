...
$sidekickforms_options = new_cmb2_box( $args );
	 ...
	 */
			...
			$sidekickforms_options->add_field( array(
				...
				'type' => 'sidekick_text',
				'icon_block'		=> 'left',  // options: 'left', 'right'
				'fa_icon'			=> 'far fa-paper-plane',  // full fontawesome markup: 'fal fa-truck'
				'icon_color'		=> 'text-gray-darken-2',  // Use BS4 "color-palette" full class 'text-dark-lighten-2'
				'icon_bg'			=> 'bg-gray-lighten-6',  // Use BS4 "color-palette" full class 'bg-dark-lighten-4'
				'icon_border'		=> 'no',  // Default is 'yes' or true. Option: 'no'.
				'classes' => array( 'col-12 col-sm-6 col-lg-4' ),
			...
			$sidekickforms_options->add_field( array(
				...
				'fa_icon'			=> 'far fa-comments',  // full fontawesome markup: 'fal fa-truck'
				'icon_color'		=> 'text-gray-darken-2',  // Use BS4 "color-palette" full class 'text-dark-lighten-2'
				'icon_bg'			=> 'bg-gray-lighten-6',  // Use BS4 "color-palette" full class 'bg-dark-lighten-4'
				'icon_border'		=> 'no',  // Default is 'yes' or true. Option: 'no'.
				'classes' => array( 'col-12 col-sm-6 col-lg-4' ),
			...
			$sidekickforms_options->add_field( array(
				...
				'type' => 'sidekick_tel',
				'icon_block'		=> 'left',  // options: 'left', 'right'
				'fa_icon'			=> 'fas fa-phone',  // full fontawesome markup: 'fal fa-truck'
				'icon_color'		=> 'text-gray-darken-2',  // Use BS4 "color-palette" full class 'text-dark-lighten-2'
				'icon_bg'			=> 'bg-gray-lighten-6',  // Use BS4 "color-palette" full class 'bg-dark-lighten-4'
				'icon_border'		=> 'no',  // Default is 'yes' or true. Option: 'no'.
				'classes' => array( 'col-12 col-sm-6 col-lg-4' ),
			...
			$sidekickforms_options->add_field( array(
				...
				'type' => 'sidekick_email',
				'icon_block'		=> 'left',  // options: 'left', 'right'
				'fa_icon'			=> 'far fa-envelope',  // full fontawesome markup: 'fal fa-truck'
				'icon_color'		=> 'text-gray-darken-2',  // Use BS4 "color-palette" full class 'text-dark-lighten-2'
				'icon_bg'			=> 'bg-gray-lighten-6',  // Use BS4 "color-palette" full class 'bg-dark-lighten-4'
				'icon_border'		=> 'no',  // Default is 'yes' or true. Option: 'no'.
				'classes' => array( 'col-12 col-sm-6 col-lg-4' ),
			...
			$sidekickforms_options->add_field( array(
				...
				'type' => 'sidekick_url',
				'icon_block'		=> 'left',  // options: 'left', 'right'
				'fa_icon'			=> 'fas fa-globe',  // full fontawesome markup: 'fal fa-truck'
				'icon_color'		=> 'text-gray-darken-2',  // Use BS4 "color-palette" full class 'text-dark-lighten-2'
				'icon_bg'			=> 'bg-gray-lighten-6',  // Use BS4 "color-palette" full class 'bg-dark-lighten-4'
				'icon_border'		=> 'no',  // Default is 'yes' or true. Option: 'no'.
				'classes' => array( 'col-12 col-sm-6 col-lg-4' ),
			...
			$sidekickforms_options->add_field( array(
				...
				'icon_block'		=> 'left',  // options: 'left', 'right'
				'fa_icon'			=> 'fas fa-key',  // full fontawesome markup: 'fal fa-truck'
				'icon_color'		=> 'text-gray-darken-2',  // Use BS4 "color-palette" full class 'text-dark-lighten-2'
				'icon_bg'			=> 'bg-gray-lighten-6',  // Use BS4 "color-palette" full class 'bg-dark-lighten-4'
				'icon_border'		=> 'no',  // Default is 'yes' or true. Option: 'no'.
				'classes' => array( 'col-12 col-sm-6 col-lg-4' ),
			...
			$sidekickforms_options->add_field( array(
				'name' => 'Sidekick Select',
				'id'   => 'sidekick_tax_select1',
				'type' => 'sidekick_taxonomy_select',
			...
			$sidekickforms_options->add_field( array(
			    ...
			    'icon_unselected'	=> 'far fa-square',  // full fontawesome 5 pro markup: 'fal fa-truck'
			    'icon_selected'		=> 'fas fa-user',  // full fontawesome markup: 'fal fa-truck'
			...
			$sidekickforms_options->add_field( array(
				...
				'icon_unselected'	=> 'far fa-square',
			    'icon_selected'		=> 'fas fa-check',
