...
add_action( 'cmb2_init', 'example_conditionals_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_init' hook.
 */
function example_conditionals_demo_metabox() {

	// Start with an underscore to hide fields from custom fields list.
	$prefix = '_example_conditions_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'show_on'      => array( 'key' => 'id', 'value' => array( 491 ) ),
		'cmb_styles'	 => false,
	) );
